 ...
 */
public class SpannedGridLayoutManagerTest extends RecyclerView.LayoutManager {
    ...
    public SpannedGridLayoutManagerTest(GridSpanLookup spanLookup, int columns, float cellAspectRatio) {
    ...
    public SpannedGridLayoutManagerTest(
