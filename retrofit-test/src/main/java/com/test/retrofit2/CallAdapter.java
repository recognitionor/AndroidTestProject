...
/**
 * Adapts a {@link com.test.retrofit2.Call} with response type {@code R} into the type of {@code T}. Instances are
 * created by {@linkplain Factory a factory} which is {@linkplain
 * com.test.retrofit2.Retrofit.Builder#addCallAdapterFactory(Factory) installed} into the {@link com.test.retrofit2.Retrofit} instance.
 */
public interface CallAdapter<R, T> {
   ...
   * com.test.retrofit2.Retrofit#create(Class) the service interface} methods.
   */
